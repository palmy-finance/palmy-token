 ...
 * @author Palmy
 */
contract PlmyTokenV2 is GovernancePowerDelegationERC20, VersionedInitializable {
  ...
  ITransferHook public _plmyGovernance;
  ...
  function _beforeTokenTransfer(address from, address to, uint256 amount) internal override {
    ...
    // caching the plmy governance address to avoid multiple state loads
    ITransferHook plmyGovernance = _plmyGovernance;
    if (plmyGovernance != ITransferHook(address(0))) {
      plmyGovernance.onTransfer(from, to, amount);
    }
  }
